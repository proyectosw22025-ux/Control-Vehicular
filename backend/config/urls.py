...
from apps.reportes.views import (
    VehiculosPDFView, SesionesPDFView, VisitasPDFView, InfraccionesPDFView,
)
...
urlpatterns = [
    ...
    path("api/pdf/infracciones/", csrf_exempt(InfraccionesPDFView.as_view()), name="pdf_infracciones"),
