...
// URL del escudo oficial — actualizar con Cloudinary cuando esté disponible
const ESCUDO_URL = 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Escudo_UAGRM.png/200px-Escudo_UAGRM.png'
