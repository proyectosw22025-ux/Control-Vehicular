...
const NAV_ITEMS = [
  ...
  { to: '/autorizaciones-externas', label: 'Autorizaciones Ext.', icon: ShieldCheck, roles: ['Administrador', 'Guardia'] },
  { to: '/visitantes',     label: 'Visitantes',     icon: UserCheck,       roles: ['Administrador', 'Guardia'] },
  { to: '/infracciones',   label: 'Infracciones',   icon: AlertTriangle,   roles: ['all'] },
