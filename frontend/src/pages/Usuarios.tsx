          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {!data?.usuarios?.length && (
                <tr><td colSpan={7} className="px-4 py-8 text-center text-slate-400 text-sm">No hay usuarios registrados</td></tr>
              )}
                ...
                <tr key={u.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => {
                          if (rolSeleccionado[u.id]) {
                            asignarRol({ variables: { usuarioId: u.id, rolId: parseInt(rolSeleccionado[u.id]) } })
                          }
                        }}
